...
// const EdgeInsets _kMenuItemPadding = EdgeInsets.symmetric(horizontal: 0.0);
// const EdgeInsetsGeometry _kAlignedButtonPadding = EdgeInsetsDirectional.only(start: 0.0, end: 4.0);
