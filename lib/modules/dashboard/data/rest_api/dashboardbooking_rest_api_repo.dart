...
class DashboardbookingRestApiRepo implements DashboardbookingRepo {
  final DashboardbookingRemoteDataSource _dataSource;

  DashboardbookingRestApiRepo(this._dataSource);
  ...
  Future<Either<RepoFailure, BaseEntity<DashboardbookingEntity>>> 
    ...
    DashboardbookingParam param,
      ...
      _dataSource.dashboardbooking(param).then(
        (value) => value.fold(
